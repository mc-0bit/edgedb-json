...
export interface Questions extends std.$Object {
  "answer": number;
  "description": string;
  "question": string;
  "name"?: string | null;
}
export interface Task extends std.$Object {
...
export interface test0 extends std.$Object {
  "hasasdda": unknown;
}
...
export namespace testModule {
  export interface avc extends std.$Object {
    "name": string;
    "question": string;
    "answer"?: number | null;
    "description"?: string | null;
  }
  export interface hasasdda extends std.$Object {
    "users": unknown;
  }
}
